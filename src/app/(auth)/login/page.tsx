...
export default function LoginPage() {
  ...
  return (
    <div className="w-full flex flex-col md:flex-row bg-card/60 dark:bg-card/80 border border-border dark:border-border/10 shadow-2xl backdrop-blur-xl overflow-hidden rounded min-h-[500px] transition-colors duration-500">
      {/* 1. PANNEAU DE GAUCHE : BRANDING / INFO */}
      <div className="hidden md:flex flex-col justify-between p-12 md:w-[400px] border-r border-border dark:border-border/10 bg-gradient-to-b from-foreground/[0.02] to-transparent">
        <div>
      ...
      <div className="flex-1 p-8 md:p-14 flex flex-col justify-center bg-background/20 dark:bg-muted/10 transition-colors duration-500">
